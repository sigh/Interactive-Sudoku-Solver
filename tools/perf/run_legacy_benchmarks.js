...
// file under tools/perf/ and runs the benchmarks they register via micro_bench_harness.
...
import { getRegisteredBenches, printBenchResult, runBench } from '../lib/micro_bench_harness.js';
...
if (args.help) {
  console.log('Usage: node tools/perf/run_legacy_benchmarks.js [--file <substring>] [--name <substring|/regex/>]');
  console.log('');
  console.log('Examples:');
  console.log('  node tools/perf/run_legacy_benchmarks.js --file util');
  console.log('  node tools/perf/run_legacy_benchmarks.js --file lookup_tables');
  console.log("  node tools/perf/run_legacy_benchmarks.js --name 'BitSet'");
  console.log("  node tools/perf/run_legacy_benchmarks.js --name '/^util::base64/'");
  process.exit(0);
}
...
if (benchFiles.length === 0) {
  console.warn('No benchmark files (*.bench.js) found under tools/perf/.');
  process.exit(0);
}
