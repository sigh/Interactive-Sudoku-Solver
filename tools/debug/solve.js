...
// that an encoding accepts a known answer, use tools/debug/verify_solution.js.
// Use tools/perf/benchmark_puzzles.js when you want search counters (guesses,
// backtracks, nodes) rather than solution content.
//
// Usage:
//   node tools/debug/solve.js --max-backtracks <n|none> [options]
//
// Required:
...
import { allPuzzles, loadPuzzle, buildSolver, printSolution } from '../lib/puzzle_runner.js';
...
Usage: node tools/debug/solve.js --max-backtracks <n|none> [options]
...
To check a known answer is accepted, use tools/debug/verify_solution.js.`);
