...
| [grid_shape.js](grid_shape.js) | Grid coordinate system. `CellGeometry` handles cell indexing (R1C1 format), value ranges, and grid dimensions (1×1 to 16×16). `CellGraph` provides adjacency queries. `VarCellRegistry` manages named variable cells outside the grid. |
