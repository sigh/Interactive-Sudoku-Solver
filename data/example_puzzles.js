const EXAMPLES = {
  ...
  'Pill arrow': {
    ...
    input: '.PillArrow~R1C3~R1C2~R1C1~R2C1~R3C1.PillArrow~R1C8~R1C7~R1C6~R1C5~R1C4.PillArrow~R2C7~R2C6~R2C5~R2C4~R2C3.PillArrow~R4C1~R5C1~R6C1~R7C1~R8C1.PillArrow~R3C2~R4C2~R5C2~R6C2~R7C2.PillArrow~R9C1~R9C2~R9C3~R9C4~R9C5.PillArrow~R5C9~R4C9~R3C9~R2C9~R1C9.PillArrow~R8C6~R9C6~R9C7~R9C8~R9C9.Arrow~R3C3~R4C4~R5C5.Arrow~R7C3~R6C4~R5C5~R4C6.Arrow~R3C8~R4C7.',
