export const DISPLAYED_EXAMPLES = [
  ...
  },
  {
    ...
    input: '.Regex~(%5B%5E1-3%5D%5B47%5D%5B69%5D%7C%5B47%5D123%5B69%5D)*~R5C2~R4C1~R3C1~R2C1~R1C1~R1C2~R2C3~R3C3~R4C3~R4C4~R4C5~R4C6~R4C7~R3C7~R2C7~R1C8~R1C9~R2C9~R3C9~R4C9~R5C8~R6C8.Regex~%2E%3F(%5B%5E47%5D%7C471)*~R5C1~R4C1~R3C2~R2C3~R2C4~R2C5~R2C6~R2C7~R3C8~R4C9~R5C9.Regex~(%5B%5E258%5D%2E%5B1346%5D%2E%5B146%5D%7C%5B134%5D%2E%2E5%2E%2E%5B346%5D)*%2E%3F~R5C8~R6C9~R7C9~R8C9~R9C9~R9C8~R9C7~R8C7~R7C7~R6C7~R6C6~R6C5~R6C4~R6C3~R7C3~R8C3~R9C3~R9C2~R9C1~R8C1~R7C1~R6C1~R5C2~R4C2.WhiteDot~R4C6~R5C6',
