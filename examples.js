const EXAMPLES = {
  ...
  'Wecoc #1': {
    ...
    input: '.Cage~24~R8C1~R9C1~R9C2~R9C3~R9C4.Cage~24~R8C2~R7C2~R7C1~R6C1~R5C1.Cage~24~R4C1~R3C1~R2C1~R1C1~R1C2.Cage~25~R2C2~R2C3~R1C3~R1C4~R1C5.Cage~26~R1C6~R1C7~R1C8~R1C9~R2C9.Cage~26~R2C8~R3C8~R3C9~R4C9~R5C9.Cage~26~R9C8~R9C9~R8C9~R7C9~R6C9.Cage~25~R9C5~R9C6~R9C7~R8C7~R8C8.Cage~21~R7C3~R8C3~R8C4~R8C5.Cage~20~R8C6~R7C6~R7C5~R7C4.Cage~20~R7C7~R7C8~R6C8~R5C8.Cage~20~R6C7~R5C7~R4C7~R4C8.Cage~20~R2C4~R3C4~R3C5~R3C6.Cage~20~R3C3~R3C2~R4C2~R5C2.Cage~20~R6C2~R6C3~R5C3~R4C3.Cage~19~R2C5~R2C6~R2C7~R3C7.Cage~13~R4C4~R5C4.Cage~9~R4C5~R4C6.Cage~5~R5C6~R6C6.Cage~17~R6C4~R6C5.~R5C5_1',
  },
  'Wecoc #1 mod A': {
