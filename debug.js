...
const testBrokenKiller = () => {
  ...
  let cs = new ConstraintSet([new FixedCellsConstraint(["R2C1#3","R6C1#9","R7C1#8"]),new SumConstraint(["R1C1","R1C2"], 3),new SumConstraint(["R1C3","R1C4","R1C5"], 15),new SumConstraint(["R2C1","R2C2","R3C1","R3C2"], 25),new SumConstraint(["R2C3","R2C4"], 17),new SumConstraint(["R3C3","R3C4","R4C4"], 9),new SumConstraint(["R1C6","R2C5","R2C6","R3C5"], 22),new SumConstraint(["R1C7","R2C7"], 4),new SumConstraint(["R1C8","R2C8"], 16),new SumConstraint(["R1C9","R2C9","R3C9","R4C9"], 15),new SumConstraint(["R3C7","R3C8","R4C7"], 20),new SumConstraint(["R3C6","R4C6","R5C6"], 8),new SumConstraint(["R4C5","R5C5","R6C5"], 17),new SumConstraint(["R5C4","R6C4","R7C4"], 20),new SumConstraint(["R4C2","R4C3"], 14),new SumConstraint(["R4C1","R5C1"], 6),new SumConstraint(["R5C2","R5C3","R6C2"], 13),new SumConstraint(["R6C3","R7C2","R7C3"], 6),new SumConstraint(["R4C8","R5C7","R5C8"], 17),new SumConstraint(["R6C1","R7C1","R8C1","R9C1"], 27)])
}
