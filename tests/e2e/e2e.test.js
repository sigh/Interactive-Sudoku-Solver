  ...
  },
  {
    ...
    puzzles: [
      ...
      '0-indexed: Sums and indexing',  // SumLine, XSum, Rellik, Lunchbox, Sandwich, Indexing, ValueIndexing, NumberedRoom
      {
        ...
        solution: 'DGEIJBFCHBIJDHECGFFECBGIHDJGCFHBJIEDCBDJIHEFGJDHEFGBICIHGFCDJBEEJICDFGHBHFBGECDJI',
      },
      {
        ...
        solution: 'CBFGEHDJIDGIJFCBHEHJEDIBGFCFIGCHEJDBBECFJDIGHJHDIBGECFICBHDJFEGGFJECIHBDEDHBGFCIJ',
      },
      {
        ...
        solution: 'CIDBJHFEGJGHFECIBDEBFDGIHCJFJBHCGDIEIHGEDJBFCDCEIFBJGHBEJCHFGDIHFCGIDEJBGDIJBECHF',
      }
    ],
  },
  {
    ...
    puzzles: [
      ...
      '6x6 Miracle Sudoku',  // Var, Sum (with coeffs), NFA (comparing sums), PerfectAllDifferent optimization
